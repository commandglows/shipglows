...
linked_systems:
  ...
  - tools/shipglowz_project_lifecycle_status.py
...
Définir les données que le TUI, les skills et la future app ShipGlowz doivent afficher à partir de la déclaration lifecycle Markdown. Ce document décrit une projection en lecture seule ; il ne crée pas une base de données ni un tracker parallèle.
...
- `proof` → `shipglowz_data/workflow/test-checklists/` ou la preuve nommée
