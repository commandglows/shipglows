...
evidence:
  ...
  - "The 2026-08-30 Windows toolchain story adds paired EN/FR article drafts and permanent runtime-doc copy while keeping availability claims gated by installed-host and release proof."
linked_artifacts:
  - "README.md"
...
| Native context intelligence explanation | `site/src/content/articles/en/ai-agents-do-not-need-more-context-they-need-the-right-context.md`, `site/src/content/articles/fr/les-agents-ia-nont-pas-besoin-de-plus-de-contexte-mais-du-bon-contexte.md`, `README.md`, `site/src/pages/docs.astro`, `site/src/pages/fr/docs.astro` | Explain why task-specific, local and explainable context is more useful than indiscriminate context accumulation, with measured evidence and visible limits | Paired Markdown articles + bounded public relays | `shipglows_data/workflow/specs/industrialize-native-context-intelligence.md`, `shipglows_data/technical/native-code-context-graph.md`, `shipglows_data/editorial/claim-register.md` | Context pipeline behavior, supported languages, pilot evidence, privacy boundary or public promise changes |
| Windows developer-tool maintenance story | `site/src/content/articles/en/keeping-your-windows-developer-tools-current-without-touching-projects.md`, `site/src/content/articles/fr/garder-ses-outils-de-developpement-windows-a-jour-sans-toucher-aux-projets.md`, `site/src/pages/docs.astro#windows-tool-updates`, `site/src/pages/fr/docs.astro#windows-tool-updates`, `site/src/data/installPages.ts` | Explain the practical value and safety boundary of separate ShipGlows, global-tool, and project-dependency update paths on native Windows | Paired Markdown articles + Astro docs/install copy | `shipglows_data/workflow/specs/windows-managed-developer-tool-updates.md`, `README.md`, `shipglows_data/technical/runtime-cli.md`, `shipglows_data/technical/installer-and-user-scope.md`, focused Windows contracts | Tool allowlist, commands, project-exclusion boundary, installed-host evidence, release status, or public availability changes |
...
| Native Windows toolchain maintenance | `site/src/pages/docs.astro#windows-tool-updates`, `site/src/pages/fr/docs.astro#windows-tool-updates`, `https://shipglows.com/shipglows`, `https://shipglows.com/fr/shipglows` | Paired EN/FR article drafts for the search and problem/solution story | Understand how to inspect and maintain ShipGlows-owned global tools without broad Windows updates or implicit project dependency changes | Docs own the permanent command and boundary explanation; articles own the practical narrative; install pages expose the capability only after release proof | draft pending installed-host and release proof |
