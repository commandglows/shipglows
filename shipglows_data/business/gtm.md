...
evidence:
  ...
  - "Operator decision 2026-08-22: lead with a business framework shared by humans and agents; identity and impact define the ambition, partnership the behavior, and technical execution a core strength"
linked_artifacts:
...
- Ambition: create distinctive identities, build businesses that make an impact, and give every ambition solid technical execution.
