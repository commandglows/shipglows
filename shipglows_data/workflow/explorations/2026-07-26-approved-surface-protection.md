...
- `shipglows_data/technical/context.md` - architecture des skills et points
  d'intégration du workflow.
- `shipglows_data/workflow/playbooks/spec-driven-workflow.md` - doctrine
...
|----------|--------------|--------|--------|-----------|
| 2026-07-26 11:00:51 UTC | Protéger les sections jugées parfaites contre les modifications agent | Comparaison commit pin, snapshots visuels et contrat de surface approuvée ; intégration proposée au workflow ShipGlows | Recommandation : registre incrémental + baseline composite + hard stop + permission bornée | Formaliser une spec et choisir un projet pilote |
