# 🚀 ShipGlows - Priority 2 Implementation Summary
...
```bash
# Port Configuration
SHIPGLOWS_PORT_RANGE_START=3000
SHIPGLOWS_PORT_RANGE_END=3100
SHIPGLOWS_PORT_MAX_ATTEMPTS=100

# SSH Tunnel Configuration
SHIPGLOWS_SSH_KEEPALIVE_INTERVAL=30
SHIPGLOWS_SSH_KEEPALIVE_MAX=3
SHIPGLOWS_SSH_REMOTE_USER=root
SHIPGLOWS_SSH_REMOTE_HOST=hetzner

# Logging Configuration
SHIPGLOWS_LOGGING_ENABLED=true
SHIPGLOWS_LOG_DIR=/var/log/shipglows
SHIPGLOWS_LOG_LEVEL=INFO
SHIPGLOWS_LOG_RETENTION_DAYS=30

# GitHub Configuration
SHIPGLOWS_GITHUB_REPO_LIMIT=20

# Performance
SHIPGLOWS_PM2_CACHE_ENABLED=true
SHIPGLOWS_PM2_CACHE_TTL=5
...
Output:
```
ShipGlows Configuration:
  Projects Dir: /root
  Port Range: 3000-3100
  Logging: true
  Log File: /var/log/shipglows/shipglows.log
  Log Level: INFO
  PM2 Cache: true
```
...
export SHIPGLOWS_PORT_RANGE_START=4000
export SHIPGLOWS_PORT_RANGE_END=4100
export SHIPGLOWS_LOG_LEVEL=DEBUG
export SHIPGLOWS_PM2_CACHE_TTL=10
...
```bash
# Tail live logs
tail -f /var/log/shipglows/shipglows.log

# View errors only
grep ERROR /var/log/shipglows/shipglows.log

# Last 20 operations
tail -20 /var/log/shipglows/shipglows.log
```

### Disable Caching (for debugging)

```bash
export SHIPGLOWS_PM2_CACHE_ENABLED=false
./menu.sh
```
...
```bash
# In config.sh
export SHIPGLOWS_PORT_MAX_ATTEMPTS=100

# In lib.sh
find_available_port() {
    local base_port=${1:-$SHIPGLOWS_PORT_RANGE_START}
    local max_range=$SHIPGLOWS_PORT_MAX_ATTEMPTS  # Configurable!
    # ...
}
```
...
$ grep myapp /var/log/shipglows/shipglows.log
[2026-01-24 17:02:19] [INFO] Starting environment: myapp on port 3001
