# 🎨 ShipGlows UX Improvement Proposal
...
First time:
  ...
  Enter DuckDNS token: ********
  [✓] Save credentials? (stored in ~/.shipglows/secrets) [y/N]
...
**Security:** Store in `~/.shipglows/secrets` with chmod 600
