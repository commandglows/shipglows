...
owner: "unknown"
user_story: "As a ShipGlows operator maintaining the skill system, I want the remaining non-lifecycle token-risk skills compacted through the established layering contract, so most specialist skills activate from concise instructions while preserving their domain guardrails."
confidence: medium
risk_level: high
security_impact: yes
docs_impact: yes
...
depends_on:
  - artifact: "shipglows_data/workflow/specs/compact-shipglows-skill-instructions-phase-2.md"
    artifact_version: "1.0.0"
...
# Spec: Compact ShipGlows Skill Instructions Phase 3

## Title

Compact ShipGlows Skill Instructions Phase 3
...
- Trigger: a maintainer runs `/sg-start Compact ShipGlows Skill Instructions Phase 3`.
...
- Resolve ShipGlows-owned paths from `${SHIPGLOWS_ROOT:-$HOME/shipglows}`.
...
- Conditional: update `shipglows_data/technical/skill-runtime-and-lifecycle.md` only if phase 3 changes compaction doctrine beyond the phase 2 convention.
...
- [x] Task 1: Capture phase 3 baseline
  - File: `shipglows_data/workflow/specs/compact-shipglows-skill-instructions-phase-3.md`
...
- [ ] CA 5: Given runtime skills changed, when validation runs, then `tools/shipglows_sync_skills.sh --check --all` reports no blocked links.
...
|----------|-------|-------|--------|--------|-----------|
| 2026-05-16 13:50:01 UTC | sg-spec | GPT-5 Codex | Created ready phase 3 spec for remaining non-lifecycle token-risk skills | ready | /sg-start Compact ShipGlows Skill Instructions Phase 3 |
| 2026-05-16 13:54:11 UTC | sg-start | GPT-5 Codex | Compacted 9 non-lifecycle token-risk skills into activation surfaces and skill-local workflow references | implemented | /sg-verify Compact ShipGlows Skill Instructions Phase 3 |
| 2026-05-16 13:54:11 UTC | sg-verify | GPT-5 Codex | Verified budget audit, metadata lint, runtime sync, and focused skill coherence checks | verified | /sg-end Compact ShipGlows Skill Instructions Phase 3 |
| 2026-05-16 13:54:11 UTC | sg-end | GPT-5 Codex | Closed phase 3 chantier and prepared quick ship | closed | /sg-ship Compact ShipGlows Skill Instructions Phase 3 |
