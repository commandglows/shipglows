...
owner: Diane
user_story: "En tant qu'utilisatrice ShipGlows qui route le contenu via sg-content et sg-repurpose, je veux que les skills de redaction, enrichissement, copy, copywriting et SEO appliquent toutes la gouvernance editoriale et technique, afin que les mises a jour de contenu, claims, pages publiques et docs ne divergent pas des contrats ShipGlows."
confidence: high
risk_level: high
security_impact: yes
docs_impact: yes
...
En tant qu'utilisatrice ShipGlows qui route le contenu via sg-content et sg-repurpose, je veux que les skills de redaction, enrichissement, copy, copywriting et SEO appliquent toutes la gouvernance editoriale et technique, afin que les mises a jour de contenu, claims, pages publiques et docs ne divergent pas des contrats ShipGlows.
...
- [x] Task 2: Update public skill pages if the public promise changes.
  ...
  - Notes: Do not add ShipGlows governance frontmatter.
...
- Integration: `tools/shipglows_sync_skills.sh --check --skill <name>` for each changed skill.
