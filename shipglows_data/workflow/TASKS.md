...
🟢 [ShipGlows] task: Recommander une nouvelle conversation uniquement quand le contexte ou l'objectif le justifie et fournir une reprise autonome | status: done | area: conversation-continuity | id: conversation-closure-and-restart-handoff | spec: shipglows_data/workflow/specs/conversation-closure-and-restart-handoff.md | verification: 43 scénarios ciblés, métadonnées, topologie et diff hygiene passent; stabilisation Git et prompt redacted imposés avant recommandation | ship_status: shipped | next: relire puis fusionner la PR ShipGlows 24 avant la revue visuelle de la PR site 13
