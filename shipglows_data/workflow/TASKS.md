...
🟠 [ShipGlows] task: Déplacer toute la documentation et l’inventaire de l’infrastructure privée vers le dépôt privé ShipGlows puis assainir les surfaces publiques | status: todo | area: private-infrastructure-governance | id: private-infrastructure-repository-boundary | source: décision utilisateur 2026-08-27 | evidence: le dépôt public contient actuellement une fiche Hetzner détaillée sans IP ni secret | boundary: ne conserver publiquement que les rôles architecturaux non sensibles; ne persister aucune IP, token, clé ou donnée client, même dans le dépôt privé | next: résoudre le dépôt privé exact, inventorier les détails opérationnels publics, les migrer puis vérifier leur retrait du dépôt public
