...
✅ [ShipGlows] task: Déplacer toute la documentation et l’inventaire de l’infrastructure privée vers le dépôt privé ShipGlows puis assainir les surfaces publiques | status: done | area: private-infrastructure-governance | id: private-infrastructure-repository-boundary | source: décision utilisateur 2026-08-27 | evidence: inventaire opérationnel ajouté au dépôt privé par le commit b4d936f; les surfaces publiques ne conservent que `sg-runtime-01`, `sg-workspaces-01` et leurs frontières architecturales | boundary: aucune IP, token, clé, credential ou donnée client n’est persistée dans Git | next: none
