...
- [x] Supply-chain fixtures require complete SHA-256 values and reject ZIP traversal and symlink/reparse entries before extraction; service CLI plans reject mutable versions.
