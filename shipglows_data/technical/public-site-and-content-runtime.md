...
This doc covers the Astro public site under `/home/claude/shipglows_app/site/`, public skill content, content routing, editorial governance, and the public/private documentation boundary. Read it before changing public docs, content pages, public skill descriptions, or anything that could publish internal technical details.

## Owned Files

| Path | Role | Edit notes |
| --- | --- | --- |
| `/home/claude/shipglows_app/site/` | Astro public site | Do not publish internal-only technical docs by accident |
| `/home/claude/shipglows_app/site/src/pages/**` | Public routes | Public copy must match product and GTM contracts |
| `/home/claude/shipglows_app/site/src/content/articles/**` | Indexed blog article source | Keep frontmatter within the `articles` schema and claims within editorial contracts |
| `/home/claude/shipglows_app/site/src/content/skills/**` | Public skill pages | Summarize outcomes, not internal prompt bodies; keep skill contract language in English by default for agent reliability |
...
| `/home/claude/shipglows_app/site/README.md` | Site-local setup | Update when site commands or runtime change |

## Entrypoints

- `npm --prefix shipglows-site run build`: public site build.
- `/home/claude/shipglows_app/site/package.json`: Node.js 24 and pnpm runtime contract for the Astro site.
- `/home/claude/shipglows_app/site/src/pages/docs.astro`: public docs overview.
- `/home/claude/shipglows_app/site/src/pages/blog/index.astro`, `/home/claude/shipglows_app/site/src/pages/blog/[slug].astro`: indexed blog hub and article route.
- `/home/claude/shipglows_app/site/src/pages/skill-modes.astro`: public launch cheatsheet and skill mode tutorial.
- `/home/claude/shipglows_app/site/src/content/articles/`: collection-backed article content.
- `shipglows_data/technical/operator-guides/skill-launch-cheatsheet.md`: Markdown version of the launch cheatsheet.
- `/home/claude/shipglows_app/site/src/pages/skills/index.astro`, `/home/claude/shipglows_app/site/src/pages/skills/[slug].astro`, and `/home/claude/shipglows_app/site/src/content/skills/`: public skill surfaces.
...
- The Astro site runtime is pinned to Node.js 24.x as declared in `/home/claude/shipglows_app/site/package.json`.
...
- Public skill content under `/home/claude/shipglows_app/site/src/content/skills/*.md` intentionally remains in English even when the surrounding public UI is localized. These pages are public explanations, but they also mirror operational skill contracts consumed by agents, which follow the English source more reliably.
- `/home/claude/shipglows_app/site/src/content/skills/*.md` must preserve `/home/claude/shipglows_app/site/src/content.config.ts`; do not add ShipGlows governance metadata unless the schema accepts it.
- The declared indexed blog surface uses `/home/claude/shipglows_app/site/src/content/articles/**` plus `/blog` and `/fr/blog` routes.
- New indexed article content must preserve the `articles` schema declared in `/home/claude/shipglows_app/site/src/content.config.ts`.
- Standalone long-form editorial pages under `/home/claude/shipglows_app/site/src/pages/` are valid article-like surfaces when they already have declared route intent in `shipglows_data/editorial/page-intent-map.md`.
...
- Build output under `/home/claude/shipglows_app/site/dist` and dependencies under `/home/claude/shipglows_app/site/node_modules` should not be treated as source docs.
...
rg -n "shipglows_data/technical|docs/technical|internal-only|secret|token|credential" /home/claude/shipglows_app/site/src shipglows_data/editorial/content-map.md
...
- `/home/claude/shipglows_app/site/` changed -> check this doc and `shipglows_data/editorial/content-map.md`.
- Public content or claim changed -> check `shipglows_data/editorial/` and the claim register.
- Runtime content changed -> check `/home/claude/shipglows_app/site/src/content.config.ts` and `shipglows_data/editorial/astro-content-schema-policy.md`.
