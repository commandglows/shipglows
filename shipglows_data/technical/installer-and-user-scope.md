...
evidence:
  ...
  - "Native Windows phases now render immediately and every prompt publishes an explicit awaiting-input state; final trusted observation can recover from ambiguous WinGet, npm, Claude, or Codex provider exits."
