...
supersedes: []
evidence:
  - "The 2026-09-02 linked skills-only update fast-forwards the clean maintainer checkout without invoking bootstrap, runtime, developer-tool, Rust, Tauri, SDK, licence, emulator, or IDE convergence."
  - "The 2026-09-02 Windows runtime transaction distinguishes staged payload files from native launchers generated by the protected installer action, while retaining both in the same manifest and rollback boundary."
