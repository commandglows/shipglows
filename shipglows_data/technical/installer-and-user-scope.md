...
evidence:
  ...
  - "The 2026-08-23 stable-channel repair converges only the official clean ShipGlows-managed Flutter checkout to a named local stable branch tracking origin/stable, with previous-revision rollback after failed executable validation."
  - "The 2026-08-23 Flutter Web browser repair exposes the validated managed Playwright Chromium through CHROME_EXECUTABLE and enforces that managed path again in the Flutter supervisor."
