...
Status priority is invariant: `skipped`/refused → distinct neutral choice; `completed` → success; blocked/unsupported → explained warning; current unresolved → active; unknown → neutral. Distinguish skipped from unknown with a label or icon, not danger styling. Completed always wins over current; skipped is never completion. Explain a genuinely blocking prerequisite or actual risk separately; a legitimate refusal is not itself an error.
