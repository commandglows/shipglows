...
supersedes: []
evidence:
  - "Operator request 2026-08-04: sg-help mode must show one line per skill with name and modes."
...
Return only the lines below for exact `302-sg-help mode` or `302-sg-help modes` requests.
...
`006-sg-design` — system | playground | audit ui|tokens|components|a11y | animation audit|design|implement|tune | redesign | migration | library add|approve|list|status
