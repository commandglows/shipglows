...
action_mcp_auth_setup() {
    ...
    echo -e "   ${GREEN}git clone <shipglows-repo-url> ~/.shipglows/runtime${NC}"
    echo -e "   ${GREEN}cd ~/.shipglows/runtime/local${NC}"
...
turso_show_login_guide() {
    ...
    echo -e "     ${GREEN}cd ~/.shipglows/runtime/local && ./install.sh${NC}"
