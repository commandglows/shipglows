...
Assert-Sg ($runtimeResolution -ge 0 -and $channelActivation -gt $runtimeResolution) 'Maintainer installation must resolve and export the managed PowerShell runtime before developer-channel activation.'
