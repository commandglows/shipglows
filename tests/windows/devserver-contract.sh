...
rg -n "Install-SgShellShortcut 'gpush' 'git push %\*'|Install-SgGitPushProfileShortcut|Remove-Item Alias:gp -Force|function global:gp \{ & git push @args \}" "$INSTALLER"
...
rg -n 'Get-SgProjectDescriptor|UsesFloxManifest|launchPath|Flox environment found' "$MODULE"
...
rg -n 'Get-SgFloxVariables|manifest\.toml|launchEnvironment.*PORT|ASTRO_DEV_BACKGROUND' "$MODULE"
rg -n 'Get-SgWorkspaceProjectCandidates|Get-SgCandidateProjects|InsideFloxProject|Get-SgProjectDescriptor' "$ENTRYPOINT"
