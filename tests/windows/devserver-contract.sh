...
test "$(rg -c 'Read-Host' "$INSTALLER")" -eq 3
...
rg -F -n 'Write-SgGlobalDevelopmentEnvironment $codexReady $playwrightInfo $pythonInfo $flutterReady $androidInfo $ideInfo' "$INSTALLER"
